...
from agents.OptimAgent_HIP import OptimAgent_HIP
...
def main():
    args = load_config("configs/hipbench_optimagent_config.yaml")
    ...
    # setup agent
    agent = OptimAgent_HIP(model=model, dataset=dataset, corpus_path=args.corpus_path)
