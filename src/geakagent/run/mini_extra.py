...
subcommands = [
    ("geakagent.run.extra.config", ["config"], "Manage the global config file"),
    ("geakagent.run.inspector", ["inspect", "i", "inspector"], "Run inspector (browse trajectories)"),
    ("geakagent.run.github_issue", ["github-issue", "gh"], "Run on a GitHub issue"),
    ("geakagent.run.extra.swebench", ["swebench"], "Evaluate on SWE-bench (batch mode)"),
    ("geakagent.run.extra.swebench_single", ["swebench-single"], "Evaluate on SWE-bench (single instance)"),
]
