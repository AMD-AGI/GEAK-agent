...
_MODEL_CLASS_MAPPING = {
    "anthropic_model": "geakagent.models.anthropic.AnthropicModel",
    "litellm": "geakagent.models.litellm_model.LitellmModel",
    "openrouter": "geakagent.models.openrouter_model.OpenRouterModel",
    "portkey": "geakagent.models.portkey_model.PortkeyModel",
    "deterministic": "geakagent.models.test_models.DeterministicModel",
    "amd_llm": "geakagent.models.amd_llm.AmdLlmModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "geakagent.models.anthropic.AnthropicModel"),
    ...
    from geakagent.models.litellm_model import LitellmModel
