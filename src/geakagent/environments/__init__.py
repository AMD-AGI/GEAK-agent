...
_ENVIRONMENT_MAPPING = {
    "docker": "geakagent.environments.docker.DockerEnvironment",
    "singularity": "geakagent.environments.singularity.SingularityEnvironment",
    "local": "geakagent.environments.local.LocalEnvironment",
    "swerex_docker": "geakagent.environments.extra.swerex_docker.SwerexDockerEnvironment",
    "bubblewrap": "geakagent.environments.extra.bubblewrap.BubblewrapEnvironment",
}
